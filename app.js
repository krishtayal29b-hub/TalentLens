...
const DEMO_CANDIDATES = [
  {
    display: "Anonymous match",
    initials: "AM",
    skills: "React, Zustand, Vite, a11y",
    missing: "None",
    score: 91,
    status: "Interview",
  },
  {
    display: "Riley Johnson",
    initials: "RJ",
    skills: "TypeScript, testing, API design",
...
const tabContent = {
  gaps: [
    "React and TypeScript are missing from this resume, so it scores in the 10–20% range for this frontend role.",
    "The resume shows Python, Django, and SQL strength, but the job requires React 18, Vite, Zustand, and frontend testing.",
    "Recommended: build one typed React dashboard with measurable UI outcomes and resubmit.",
  ],
  strengths: [
    "Backend fundamentals are clear — REST APIs, relational data modeling, and production debugging.",
    "Good foundation for full-stack work if paired with modern frontend evidence.",
    "Project depth is present; it needs role-specific translation for frontend hiring teams.",
  ],
  questions: [
    "Walk me through a React component you designed for accessibility and state management.",
    "How would you migrate a Django-rendered page into a React + TypeScript SPA?",
    "What testing strategy would you use for a Vite dashboard with server-state caching?",
  ],
};
...
function initEvents() {
  ...
  qs("#uploadZone")?.addEventListener("click", () => {
    ...
    qs("#scoreRing")?.style.setProperty("--score", "18");
    showToast("Python + Django resume scored 18% for React + TypeScript.");
